    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <sticky :z-index="10" :class-name="'sub-navbar '+postForm.status">
        <el-button
          ...
          type="success"
          @click="submitForm"
          v-permission="['sys:sysconfig:push']"
        >发布</el-button>
        <el-button
          v-loading="loading"
          type="warning"
          v-permission="['sys:sysconfig:save']"
          @click="draftForm"
        >确认</el-button>
      </sticky>
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 40px;" prop="value" label-width="90px" label="静态值:">
          <el-input
