    ...
    <div class="app-container">
        ...
        >
            ...
            <el-table-column fixed="right" align="left" label="操作" width="120px">
                <template slot-scope="scope">
                    <router-link v-permission="['sys:sysauthorities:delete']" :to="'/systemAuth/SysAuthoritiesEdit/'+scope.row.id">
                        <el-tooltip class="item" effect="dark" content="编辑" placement="bottom">
                            <el-button v-permission="['sys:sysauthorities:update']" type="primary" size="small" icon="el-icon-edit" />
                        </el-tooltip>
                    </router-link>
...
<script>
    ...
    import { findByListSysAuthorities, delSysAuthorities } from "@/api/sys/SysAuthoritiesApi";
