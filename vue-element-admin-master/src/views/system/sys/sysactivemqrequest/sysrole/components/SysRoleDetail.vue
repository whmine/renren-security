    ...
    <div class="createPost-container">
        <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
            <sticky :z-index="10" :class-name="'sub-navbar '+postForm.status">
                ...
                >发布</el-button>
                <el-button v-loading="loading" type="warning" v-permission="['sys:sysrole:save']" @click="draftForm">确认</el-button>
            </sticky>
            ...
            <div class="createPost-main-container">
                <el-form-item style="margin-bottom: 40px;" prop="name" label-width="90px" label="名称:">
                    ...
                    <el-form-item style="margin-bottom: 40px;" prop="inheritable" label-width="90px" label="可否继承:">
                    <el-input
                    ...
                    <el-form-item style="margin-bottom: 40px;" prop="parentRole" label-width="90px" label="继承角色:">
                    <el-input
