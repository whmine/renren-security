    ...
    <div class="createPost-container">
        <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
            <sticky :z-index="10" :class-name="'sub-navbar '+postForm.status">
                ...
                >发布</el-button>
                <el-button v-loading="loading" type="warning" v-permission="['sys:sysauthorities:save']" @click="draftForm">确认</el-button>
            </sticky>
            ...
            <div class="createPost-main-container">
                <el-form-item style="margin-bottom: 40px;" prop="name" label-width="90px" label="名称:">
                    ...
                    <el-form-item style="margin-bottom: 40px;" prop="authorities" label-width="90px" label="SPRING权限名称:">
                    <el-input
