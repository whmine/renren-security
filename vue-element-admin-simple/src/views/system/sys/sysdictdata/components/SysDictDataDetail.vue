    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      <sticky :z-index="10" :class-name="'sub-navbar '+postForm.status">
        <el-button
          ...
          type="success"
          @click="submitForm"
          v-permission="['sys:sysdictdata:push']"
        >发布</el-button>
        <el-button
          v-loading="loading"
          type="warning"
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item style="margin-bottom: 40px;" prop="dictType" label-width="90px" label="字典类型:">
          <el-input
            v-model="postForm.dictType"
            :rows="1"
            type="textarea"
            class="article-textarea"
            autosize
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        dictLabel: [{ validator: validateRequire }],
        dictValue: [{ validator: validateRequire }],
        dictType: [{ validator: validateRequire }]
      },
      tempRoute: {}
    };
  },
