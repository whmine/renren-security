<template>
    <div class="app-container">
        <div class="filter-container">
            <router-link v-permission="['device:deviceline:save']" :to="'/deviceResource/DeviceLineCreate'">
        ...
        >
            ...
            <el-table-column fixed="right" align="left" label="操作" width="120px">
                <template slot-scope="scope">
                    <router-link v-permission="['device:deviceline:update']" :to="'/deviceResource/DeviceLineEdit/'+scope.row.id">
                        <el-tooltip class="item" effect="dark" content="编辑" placement="bottom">
                            <el-button  type="primary" size="small" icon="el-icon-edit" />
                        </el-tooltip>
                    </router-link>
                    <el-tooltip class="item" v-permission="['device:deviceline:delete']" effect="dark" content="删除" placement="bottom">
                        <el-button
                                size="small"
                                type="primary"
                                icon="el-icon-delete"
                                @click="deleteDeviceLine(scope.row.id)"
                        />
                    </el-tooltip>
                </template>
            </el-table-column>
...
<script>
    ...
    import { findByListDeviceLine, delDeviceLine } from "@/api/device/DeviceLineApi";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                findByListDeviceLine(this.listQuery).then(response => {
            ...
            deleteDeviceLine(data) {
                delDeviceLine({ id: data }).then(response => {
                    this.getList();
                });
            }
        }
