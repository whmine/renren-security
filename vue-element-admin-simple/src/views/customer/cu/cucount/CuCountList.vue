<template>
    <div class="app-container">
        <div class="filter-container">
            <router-link v-permission="['cu:cucount:save']" :to="'/customer/CuCountCreate'">
        ...
        >
            ...
            <el-table-column width="280px" align="center" label="星级">
                <template slot-scope="scope">
            ...
            <el-table-column fixed="right" align="left" label="操作" width="120px">
                <template slot-scope="scope">
                    <router-link v-permission="['cu:cucount:update']" :to="'/customer/CuCountEdit/'+scope.row.id">
                        <el-tooltip class="item" effect="dark" content="编辑" placement="bottom">
                            <el-button  type="primary" size="small" icon="el-icon-edit" />
                        </el-tooltip>
                    </router-link>
                    <el-tooltip class="item" v-permission="['cu:cucount:delete']" effect="dark" content="删除" placement="bottom">
                        <el-button
                                size="small"
                                type="primary"
                                icon="el-icon-delete"
                                @click="deleteCuCount(scope.row.id)"
                        />
                    </el-tooltip>
                </template>
            </el-table-column>
...
<script>
    ...
    import { findByListCuCount, delCuCount } from "@/api/cu/CuCountApi";
    ...
    export default {
        ...
        methods: {
            ...
            getList() {
                ...
                findByListCuCount(this.listQuery).then(response => {
            ...
            deleteCuCount(data) {
                delCuCount({ id: data }).then(response => {
                    this.getList();
                });
            }
        }
