...
public class PayUtil {
     ...
     * @return
     */
    public static String getKeyNo(String key) {
        // 自增8位数 00000001
        return key + DatetimeUtil.formatDate(new Date(), DatetimeUtil.TIME_STAMP_PATTERN);
    }
    ...
    public static String getGoodsNo() {
        // 自增8位数 00000001
        return "GS" + DatetimeUtil.formatDate(new Date(), DatetimeUtil.TIME_STAMP_PATTERN) + "00000001";
    }
    ...
    public static String getSign(Map<String, String> params, String paternerKey) throws UnsupportedEncodingException {
        log.debug("key:" + paternerKey);
        String para = createSign(params, false) + "&key=" + paternerKey;
        log.debug("参数：" + para);
        String str = MD5Utils.getMD5(para).toUpperCase();
        log.debug("加密参数：" + str);
        return str;
    }
