...
import io.renren.common.exception.FileNameLengthLimitExceededException;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = "C://upload//";
     ...
     * @param fileName
     */
    public static void delImg(String fileName) {
        if (!StringUtils.isBlank(fileName)) {
            File file = new File(getDefaultBaseDir() + fileName);
            if (file.isFile()) {
                file.delete();
            }
     ...
     * @param filePaht
     */
    public static void delImgUrl(String filePaht) {
        if (!StringUtils.isBlank(filePaht)) {
